...
public class Traveller extends Person{
	...
	public void observe(double observationRate) {
		if (this.getLocation()!=SpaceObject.BigEarth) {
			...
			System.out.println(this.getName()+" meets citizens of Davilon! "+Lunatic.Davilon.getAbout());
			...
			if (asker instanceof Journalist) {
				switch (choise) {
					...
					case 2: System.out.println("I was dreaming about home.");
						break;
					case 3: System.out.print("They were really "+Lunatic.Davilon.getBehavior()+". ");
						if (Lunatic.Davilon.getBehavior()==Mood.Angry | Lunatic.Davilon.getBehavior()==Mood.Smart) {
				...
				switch (choise) {
					...
					case 1: System.out.println(observations[1]);
						break;
					case 2: System.out.println("No, it doesn't");
						break;
					default: System.out.println("I'm good.");
				}
			}
